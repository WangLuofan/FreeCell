...
static var CARD_TABLE_PADDING: float = 8.0
static var CARD_SUIT_TOTAL_COUNT: int = 4
static var CARD_VALUE_TOTAL_COUNT: int = 13
static var CARD_VISIBLE_HEIGHT: float = 20.0
